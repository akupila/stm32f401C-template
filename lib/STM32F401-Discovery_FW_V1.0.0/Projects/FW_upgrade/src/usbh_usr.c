...
void USBH_USR_Init(void)
{
  ...
  {
    startup = 1;
    /* Initialize LEDs and Push_Button on STM32F401-Discovery**************************/
...
int USBH_USR_MSC_Application(void)
{
  ...
  case USH_USR_IAP:
    ...
    /* Initialize User_Button on STM32F401-Discovery in the EXTI Mode --------*/
    ...
    /* Initialize User_Button on STM32F401-Discovery in the GPIO Mode --------*/
    STM_EVAL_PBInit(BUTTON_USER, BUTTON_MODE_GPIO);
