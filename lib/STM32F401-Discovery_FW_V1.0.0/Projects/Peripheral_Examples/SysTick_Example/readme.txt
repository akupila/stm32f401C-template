...
1 ms. The system clock is set to 84 MHz, the SysTick is clocked by the AHB clock
(HCLK).
...
@par Directory contents 
  ...
  - SysTick_Example/stm32f4xx_it.h       Header for stm32f4xx_it.c 
  - SysTick_Example/main.c               Main program
  - SysTick_Example/main.h               Header for main.c
  - SysTick_Example/system_stm32f4xx.c   STM32F4xx system source file
