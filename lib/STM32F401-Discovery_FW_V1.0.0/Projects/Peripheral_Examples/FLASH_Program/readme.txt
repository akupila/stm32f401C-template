...
If MemoryProgramStatus is equal to 0, then data is correctly programmed so LED4 is on.
If MemoryProgramStatus is different of 0, then data is not correctly programmed 
so LED5 is on.
