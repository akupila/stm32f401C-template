/**
  ...
  *          write protection for the STM32F401x FLASH
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* Initialize Key Button mounted on STM32F401C-DISCO board */
  STM_EVAL_PBInit(BUTTON_USER, BUTTON_MODE_GPIO);

  /* Test if Key push-button on STM32F401C-DISCO board is pressed */
