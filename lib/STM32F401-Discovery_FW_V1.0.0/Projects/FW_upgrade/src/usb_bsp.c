...
/** @addtogroup STM32F401-Discovery_FW_Upgrade
  * @{
  */
...
/**
  ...
  *         This function provides delay time in microseconds
  * @param  usec: Value of delay required in microseconds
  * @retval None
  */
...
/**
  ...
  *          This function provides delay time in milliseconds.
  * @param  msec: Value of delay required in milliseconds
  * @retval None
  */
...
/**
  ...
  * @param  unit: Delay Time unit : miliseconds / microseconds
  * @retval None
  */
static void BSP_Delay(uint32_t nTime, uint8_t unit)
{
