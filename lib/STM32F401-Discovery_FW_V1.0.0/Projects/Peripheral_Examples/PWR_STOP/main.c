/**
  ...
  * @brief   This example shows how to enters the system to STOP mode
  *          and wake-up from this mode
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* Initialize LEDs and User Button mounted on STM32F401C-DISCO board */
